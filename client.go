...
// APIClient manages communication with the Kardinal ARO API API v2.45.0
...
type APIClient struct {
	...
	SimplePlanAPI *SimplePlanAPIService

	SmartMeetingAppointmentAPI *SmartMeetingAppointmentAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SimplePlanAPI = (*SimplePlanAPIService)(&c.common)
	c.SmartMeetingAppointmentAPI = (*SmartMeetingAppointmentAPIService)(&c.common)
...
func (c *APIClient) decode(v interface{}, b []byte, contentType string) (err error) {
	...
	// ... (os.File logic remains unchanged) ...
	...
	// --- JSON Decoding (Polymorphic check removed) ---
	if JsonCheck.MatchString(contentType) {
		// The entire 'actualObj' / 'GetActualInstance()' block is removed here.

		// Force standard JSON unmarshal
