...
// checks if the ProductConf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductConf{}

// ProductConf A product configuration.
...
func (o ProductConf) MarshalJSON() ([]byte, error) {
...
func (o ProductConf) ToMap() (map[string]interface{}, error) {
...
type NullableProductConf struct {
	value *ProductConf
	isSet bool
}

func (v NullableProductConf) Get() *ProductConf {
	return v.value
}

func (v *NullableProductConf) Set(val *ProductConf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductConf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductConf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductConf(val *ProductConf) *NullableProductConf {
	return &NullableProductConf{value: val, isSet: true}
}

func (v NullableProductConf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductConf) UnmarshalJSON(src []byte) error {
	v.isSet = true
