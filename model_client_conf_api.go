...
// checks if the ClientConfApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientConfApi{}

// ClientConfApi struct for ClientConfApi
type ClientConfApi struct {
...
func (o ClientConfApi) MarshalJSON() ([]byte, error) {
...
func (o ClientConfApi) ToMap() (map[string]interface{}, error) {
...
type NullableClientConfApi struct {
	value *ClientConfApi
	isSet bool
}

func (v NullableClientConfApi) Get() *ClientConfApi {
	return v.value
}

func (v *NullableClientConfApi) Set(val *ClientConfApi) {
	v.value = val
	v.isSet = true
}

func (v NullableClientConfApi) IsSet() bool {
	return v.isSet
}

func (v *NullableClientConfApi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientConfApi(val *ClientConfApi) *NullableClientConfApi {
	return &NullableClientConfApi{value: val, isSet: true}
}

func (v NullableClientConfApi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientConfApi) UnmarshalJSON(src []byte) error {
	v.isSet = true
